...
""")
        ...
        self.edPassport.setPlaceholderText("только 11 цифр")
        self.edPassport.setValidator(QRegularExpressionValidator(QRegularExpression(r"^\d{11}$"), self.edPassport))
        ...
        self.sbRoomNumber = QSpinBox(self.pgRoom); self.sbRoomNumber.setMinimum(1)
